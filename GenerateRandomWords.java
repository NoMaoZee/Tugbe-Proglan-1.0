...
public class GenerateRandomWordsFX extends Application {
    ...
    private void generateRandomWords() {
        ...
        saveInputToFile(kataList);
    }

    private void saveInputToFile(ArrayList<String> kataList) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("Results Generate.txt", true))) {
            ...
            System.out.println("Input berhasil disimpan ke dalam file.");
        } catch (IOException e) {
            System.out.println("Gagal menyimpan input ke dalam file: " + e.getMessage());
        }
    }
}